      ...
      var leaderboardCharacters = this.state.characters.map(function (character) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('img', { className: 'thumb-md', src: 'http://image.eveonline.com/Character/' + character.characterId + '+128.jpg' })
          )
        );
      });
...
},{"./Actions":23,"./DOMStateStorage":25,"./DOMUtils":26,"./ExecutionEnvironment":27,"./createDOMHistory":29,"_process":37,"invariant":36}],29:[function(require,module,exports){
(function (process){
'use strict';
...
module.exports = exports['default'];
},{"./Actions":23,"./AsyncUtils":24,"./createLocation":31,"./deprecate":32,"./runTransitionHook":35,"deep-equal":20}],31:[function(require,module,exports){
'use strict';
...
},{"_process":37,"warning":38}],33:[function(require,module,exports){
"use strict";
